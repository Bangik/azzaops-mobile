...
class WorkOrderModel {
  ...
  factory WorkOrderModel.fromJson(Map<String, dynamic> json) {
    ...
    if (json['type'] is Map) {
      parsedType = WorkOrderTypeModel.fromJson(
    ...
    if (json['customer'] is Map) {
      parsedCustomer = CustomerModel.fromJson(
    ...
    VendorModel? parsedVendor;
    if (json['vendor'] is Map) {
      parsedVendor = VendorModel.fromJson(
    ...
    if (json['service_category'] is Map) {
      parsedCategory = ServiceCategoryModel.fromJson(
    ...
    return WorkOrderModel(
      ...
      jobOrder: json['job_order'] is int
          ? json['job_order'] as int
          : int.tryParse(json['job_order']?.toString() ?? ''),
      ...
      parentWoId: json['parent_wo_id'] is int
          ? json['parent_wo_id'] as int
          : int.tryParse(json['parent_wo_id']?.toString() ?? ''),
